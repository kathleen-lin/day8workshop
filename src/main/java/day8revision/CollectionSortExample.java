 ...
 */
    ...
    public void example02(){
       ...
       List<Employee> filteredEmployess = employees.stream().filter(e -> e.getFullName().equalsIgnoreCase("he yan")).collect(Collectors.toList());
       System.out.println("Filtered employees: " + filteredEmployess);
    }
